...
public class SP2DGLRenderer implements GLSurfaceView.Renderer{
	private static final String TAG = "SP2DGLRenderer";
    public static SpringPendulum2D mPendulum = new SpringPendulum2D
    		(75., 50., 1., 
    		75., 0.,
    		75., 0.,
    ...
    private void appendAccum() {
        ...
        SP2DGLRenderer.orthoGL(mPendulum.mProjMatrix, Width, Height);
