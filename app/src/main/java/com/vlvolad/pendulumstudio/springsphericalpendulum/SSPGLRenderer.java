...
public class SSPGLRenderer implements GLSurfaceView.Renderer{
	private static final String TAG = "SSPGLRenderer";
    public static SpringSphericalPendulum mPendulum = new SpringSphericalPendulum
    		(75., 75., 1., 1., 50., 0., 0., 75., 
    ...
    private void appendAccum() {
        ...
        SSPGLRenderer.perspectiveGL(mPendulum.mProjMatrix, 45.0f, (float)(Width)/Height,0.1f,1200.0f);
        //SSPGLRenderer.orthoGL(mPendulum.mProjMatrix, Width, Height);
