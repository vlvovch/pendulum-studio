...
public class DSPGLRenderer implements GLSurfaceView.Renderer{
	private static final String TAG = "DSPGLRenderer";
    public static DoubleSphericalPendulum mPendulum = new DoubleSphericalPendulum(75., 75., 1., 1., 45. * Math.PI / 180., 90. * Math.PI / 180.,
