...
public class SP3DGLRenderer implements GLSurfaceView.Renderer{
	private static final String TAG = "SP3DGLRenderer";
    public static SpringPendulum3D mPendulum = new SpringPendulum3D
    		(75., 50., 1., 
    		75., 0.,
    		75., 0.,
    		75., 0., 
