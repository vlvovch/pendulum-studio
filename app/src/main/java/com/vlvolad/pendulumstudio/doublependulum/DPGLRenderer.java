...
public class DPGLRenderer implements GLSurfaceView.Renderer{
	private static final String TAG = "DPGLRenderer";
    public static DoublePendulum mPendulum = new DoublePendulum(75., 75., 1., 1., 45. * Math.PI / 180.,
	...
	private void appendAccum() {
		...
		DPGLRenderer.orthoGL(mPendulum.mProjMatrix, Width, Height);
