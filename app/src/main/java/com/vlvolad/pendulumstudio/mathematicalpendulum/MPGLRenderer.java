...
public class MPGLRenderer implements GLSurfaceView.Renderer{
	private static final String TAG = "MPGLRenderer";
	public static MathematicalPendulum mPendulum = new MathematicalPendulum(100., 1., 90. * Math.PI / 180.,
    ...
    private void appendAccum() {
        ...
        MPGLRenderer.orthoGL(mPendulum.mProjMatrix, Width, Height);
